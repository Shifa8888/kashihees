...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans selection:bg-amber-400 selection:text-black">
        ...
        {activeTab === 'shop' && (
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap items-center gap-1.5 border-b border-zinc-900 pb-4">
              ...
              {['All', 'Urban Streetwear', 'Traditional Elegance', 'Luxe Evening', 'Casual Chic'].map((cat) => {
      ...
      {/* Footer Branding */}
      <footer className="border-t border-zinc-900 bg-zinc-950 mt-16 py-12 text-zinc-500 text-xs">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-zinc-900 text-center flex flex-col sm:flex-row justify-between items-center gap-4">
          <p>© 2026 Kashi's Styles Atelier. Designed for absolute premium self-expression.</p>
